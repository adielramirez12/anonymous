...
msg -bar2
msg -ama "     [ VPS - MX - SCRIPT \033[1;97m ❌ Anonymous ❌\033[1;33m ]"
msg -bar
echo -e "\033[97m"
...
function_verify () {
wget -O /usr/bin/trans https://raw.githubusercontent.com/adielramirez12/anonymous/master/trans &> /dev/null
wget -O /etc/versin_script https://raw.githubusercontent.com/adielramirez12/anonymous/master/Version &> /dev/null
wget -O /usr/bin/SPR https://raw.githubusercontent.com/adielramirez12/anonymous/master/SPR &> /dev/null
chmod +x /usr/bin/SPR
## lognull
...
[[ $(find /etc/VPS-MX/controlador -name nombre.log|grep -w "nombre.log"|head -1) ]] || wget -O /etc/VPS-MX/controlador/nombre.log https://raw.githubusercontent.com/adielramirez12/anonymous/master/nombre.log &>/dev/null
[[ $(find /etc/VPS-MX/controlador -name IDT.log|grep -w "IDT.log"|head -1) ]] || wget -O /etc/VPS-MX/controlador/IDT.log https://raw.githubusercontent.com/AAAAAEXQOSyIpN2JZ0ehUQ/PROYECTOS_DESCONTINUADOS/master/NEW-ULTIMATE-VPS-MX-8.0/VPS-MX-v8.4/Install/ArchivosUtilitarios/IDT.log &>/dev/null
[[ $(find /etc/VPS-MX/controlador -name tiemlim.log|grep -w "tiemlim.log"|head -1) ]] || wget -O /etc/VPS-MX/controlador/tiemlim.log https://raw.githubusercontent.com/adielramirez12/anonymous/master/tiemlim.log &>/dev/null

wget -O /bin/rebootnb https://raw.githubusercontent.com/adielramirez12/anonymous/master/rebootnb &> /dev/null
chmod +x /bin/rebootnb 
wget -O /bin/resetsshdrop https://raw.githubusercontent.com/adielramirez12/anonymous/master/resetsshdrop &> /dev/null
chmod +x /bin/resetsshdrop
wget -O /etc/versin_script_new https://raw.githubusercontent.com/adielramirez12/anonymous/master/Version &>/dev/null
wget -O /etc/versin_script https://raw.githubusercontent.com/adielramirez12/anonymous/master/Version &>/dev/null
msg -bar2
...
echo 'wget -O /etc/versin_script_new https://raw.githubusercontent.com/adielramirez12/anonymous/master/Version &>/dev/null'>> .bashrc
echo 'echo ""'>> .bashrc
...
fun_ip
wget -O /usr/bin/trans https://raw.githubusercontent.com/adielramirez12/anonymous/master/trans &> /dev/null
wget -O /bin/Desbloqueo.sh https://raw.githubusercontent.com/adielramirez12/anonymous/master/Desbloqueo.sh &> /dev/null
chmod +x /bin/Desbloqueo.sh
wget -O /bin/monitor.sh https://raw.githubusercontent.com/adielramirez12/anonymous/master/monitor.sh &> /dev/null
chmod +x /bin/monitor.sh
wget -O /var/www/html/estilos.css https://raw.githubusercontent.com/adielramirez12/anonymous/master/estilos.css &> /dev/null
msg -bar2
msg -bar2
msg -ama "     [ VPS - MX - SCRIPT \033[1;97m ❌ Anonymous ❌\033[1;33m ]"
